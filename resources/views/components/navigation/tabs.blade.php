<div class="mb-10">
    <h1 class="mb-4 text-xl font-medium">{{ __('Tabs') }}</h1>
    <div class="flex flex-col gap-y-5 bg-gray-200/60 p-4 lg:p-10">
        ...
        ['label' => 'Tab 4', 'panelId' => 'panel-id-4'],
            ...
            <x-dashui-tab-panel panelId="panel-id-1">
                <p class="font-semibold text-sm">{{ __('Tab All') }}</p>
                <p>{{ __('Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur culpa ea eaque fuga, illo, magnam modi nesciunt nostrum obcaecati odit reprehenderit sapiente? Autem eaque excepturi ipsa, itaque laborum magni voluptate?') }}</p>
            </x-dashui-tab-panel>
            <x-dashui-tab-panel panelId="panel-id-2">
                <p class="font-semibold text-sm">{{ __('Tab 2') }}</p>
                <p>{{ __('Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur culpa ea eaque fuga, illo, magnam modi nesciunt nostrum obcaecati odit reprehenderit sapiente? Autem eaque excepturi ipsa, itaque laborum magni voluptate?') }}</p>
            </x-dashui-tab-panel>
            <x-dashui-tab-panel panelId="panel-id-3">
                <p class="font-semibold text-sm">{{ __('Tab 3') }}</p>
                <p>{{ __('Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur culpa ea eaque fuga, illo, magnam modi nesciunt nostrum obcaecati odit reprehenderit sapiente? Autem eaque excepturi ipsa, itaque laborum magni voluptate?') }}</p>
            </x-dashui-tab-panel>
            <x-dashui-tab-panel panelId="panel-id-4">
                <p class="font-semibold text-sm">{{ __('Tab 4') }}</p>
                <p>{{ __('Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur culpa ea eaque fuga, illo, magnam modi nesciunt nostrum obcaecati odit reprehenderit sapiente? Autem eaque excepturi ipsa, itaque laborum magni voluptate?') }}</p>
            </x-dashui-tab-panel>
        </x-dashui-tabs>
        ...
        ['label' => 'Tab 3', 'panelId' => 'card-id-3'],
                ...
                <x-dashui-tab-panel panelId="card-id-1">
                    <p class="font-semibold text-sm">{{ __('Tab 1') }}</p>
                    <p>{{ __('Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur culpa ea eaque fuga, illo, magnam modi nesciunt nostrum obcaecati odit reprehenderit sapiente? Autem eaque excepturi ipsa, itaque laborum magni voluptate?') }}</p>
                </x-dashui-tab-panel>
